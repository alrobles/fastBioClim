...
rcpp_parallel_average <- function(mat_1, na_rm = TRUE) {
    .Call(`_fastbioclim_rcpp_parallel_average`, mat_1, na_rm)
}

get_openmp_info <- function() {
    .Call(`_fastbioclim_get_openmp_info`)
}
