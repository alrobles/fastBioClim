...
parallel_which_min_quarter <- function(mat, wrap = FALSE, na_rm = FALSE) {
  ...
  idx_mat <- rcpp_parallel_which_min_rolling_quarter(mat,
    wrap = wrap,
    na_rm = na_rm
  )
