...
rcpp_parallel_coef_var <- function(mat_1) {
    .Call(`_fastBioClim_rcpp_parallel_coef_var`, mat_1)
}
...
rcpp_get_avg_quarter <- function(quarter, mat) {
    .Call(`_fastBioClim_rcpp_get_avg_quarter`, quarter, mat)
}

rcpp_get_sum_quarter <- function(quarter, mat) {
    .Call(`_fastBioClim_rcpp_get_sum_quarter`, quarter, mat)
}
...
rcpp_parallel_quotient <- function(mat_1, mat_2) {
    .Call(`_fastBioClim_rcpp_parallel_quotient`, mat_1, mat_2)
}
